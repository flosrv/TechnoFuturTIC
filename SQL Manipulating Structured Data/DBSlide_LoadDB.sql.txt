...
CREATE TABLE student (
  ...
  constraint FK_student_section foreign key (section_id) references section (section)
)

CREATE TABLE grade (
  grade char(2) NOT NULL check (value in ('E','TB','B','S','F','I','IG')),
